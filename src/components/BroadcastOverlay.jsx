...
const BroadcastOverlay = ({ matchId }) => {
    ...
    return (
        <div className="w-full h-full flex items-end justify-center pb-4 animate-fade-in pointer-events-none">
            ...
            <div className="flex items-center justify-between bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border-t-2 border-yellow-500 shadow-2xl rounded-lg overflow-hidden relative h-12 w-full max-w-[95%] mx-auto">
