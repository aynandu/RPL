...
const BroadcastOverlay = ({ matchId }) => {
    ...
    return (
        <div className="w-full h-full flex items-end justify-center pb-4 animate-fade-in pointer-events-none">
            ...
            <div className="flex items-center justify-between bg-gradient-to-r from-[#111111] via-[#1a1a1a] to-[#111111] border-t-2 border-yellow-500 shadow-2xl rounded-lg overflow-hidden relative h-12 w-full max-w-[95%] mx-auto">

                {/* Background Pattern/Texture (Optional) */}
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>

                {/* Team 1 Section (Left) */}
                <div className="flex items-center h-full pl-3 pr-2 bg-gradient-to-r from-[#111111]/90 to-transparent relative z-10 min-w-[25%]">
                ...
                <div className="flex items-center justify-end h-full pr-3 pl-2 bg-gradient-to-l from-[#111111]/90 to-transparent relative z-10 min-w-[25%] text-right">
